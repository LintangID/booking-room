                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="edituser_aksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <label class="col-sm-2 col-sm-4 control-label">Role</label>
                                        <div class="col-sm-6">
                                            <select class="form-control" required disabled>
                                                ...
                                                <option value="siswa" <?= $data['role'] == 'pengguna' ? 'selected' : '' ?>>Pengguna</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="departemen" class="form-control" id="deskripsi" type="text" value="<?php echo $data['departemen']; ?>" required />
                                        </div>
                                    </div>

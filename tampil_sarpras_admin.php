                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Ruangan Head Office</h6>
                        </div>
                        <div class="card-body">
                        <div class="col-md-3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $no=0;
                                        $data = mysqli_query($koneksi, "select * from head_office");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_sarpras.php?id=<?php echo $d['id']; ?>" class="btn-sm btn-primary"><span class="fas fa-edit"></a>
                                                    <a href="hapus_sarpras.php?id=<?php echo $d['id']; ?>" class="btn-sm btn-danger"><span class="fas fa-trash"></a>
                                                </td>
                                            </tr>
                            </div>
                        <?php
    ...
    <div class="text-gray-900 modal-dialog modal-lg">
        <div class="modal-content">
            <div class="card-header modal-header">
                <h4 class="modal-title">Tambah Data Ruangan Head Office</h4>
            ...
            <div class="modal-body">
                <form role="form" action="tambahsarpras_aksi.php" method="post" enctype="multipart/form-data">

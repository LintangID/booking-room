    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4><b>GAGAL!</h4>
                <img src="img/gagal.png" width="100px"/><br><br>
            RESERVASI RUANG MEETING GAGAL</b>
<p> Tanggal yang diajukan pada ruangan ini sudah ada dan dikonfirmasi.</p>
            </div>
            <div class="modal-footer">
            <a href="riwayat_peminjaman.php" class="btn btn-success">Tutup</a>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    const autoCloseTime = 10000; // Contoh: tutup setelah 5 detik (5000 milidetik)
